...
function navBar() {
    var nav = '<nav style="float:left;"><a href = index.html><button class = "button1">Home</button></nav></a>';
    nav += '<nav style="float:left;"><a href = goodies.html><button class = "button1">Goodies</button></nav></a>';
